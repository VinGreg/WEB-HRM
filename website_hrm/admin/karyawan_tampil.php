          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <a href ="karyawan_tambah.php"><button type="submit" class="btn btn-primary">Tambah</button><a>
                <a href ="karyawan_cetak.php" class="btn btn-info">Export Data</a>
              </div>
        ...
        ORDER BY karyawan.nama") or die(mysqli_error($koneksi));
         ...
         while ($data = mysqli_fetch_array($sql)) {
           ...
           ?>
                                              ...
                                              <td>
                                                  <a href ="karyawan_edit.php<?php echo '?id=' . $id; ?> <button type="submit" class="btn btn-warning">Edit<a>  
