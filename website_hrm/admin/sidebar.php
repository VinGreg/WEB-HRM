...
?>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Admin</php></a>
        </div>
      </div>
...
<li class="nav-item has-treeview">
    ...
    <ul class="nav nav-treeview">
        <!-- Add your Cetak Laporan submenu items here -->
        <li class="nav-item">
            <a href="karyawan_cetak.php" class="nav-link <?php echo isActiveMenu('export.php'); ?>">
    ...
    $(document).ready(function () {
        // Hapus kelas 'menu-open' dari semua 'nav-item'
        $('.nav-sidebar .nav-item').removeClass('menu-open');

        $('.nav-sidebar .nav-treeview a').on('click', function (e) {
            // Periksa apakah 'nav-item' memiliki sub-menu
            if ($(this).siblings('ul.nav-treeview').length > 0) {
                e.preventDefault();

                // Periksa apakah 'nav-item' sudah terbuka
                var isOpen = $(this).closest('.nav-item').hasClass('menu-open');

                // Tutup semua 'nav-item' yang sudah terbuka
                $('.nav-sidebar .nav-item').removeClass('menu-open');

                // Buka 'nav-item' jika sebelumnya tidak terbuka
                if (!isOpen) {
