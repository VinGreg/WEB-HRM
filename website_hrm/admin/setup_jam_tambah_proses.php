...
$simpan = mysqli_query($koneksi, "INSERT INTO setup_jam VALUES(NULL,'$tanggal_efektif','$jam_masuk_set','$jam_keluar_set','$jam_masuk_old','$jam_keluar_old')") or die(mysqli_error($koneksi));
...
if ($simpan) {
	...
	echo '<script type="text/javascript">window.location="setup_jam_tambah.php"</script>';
}
