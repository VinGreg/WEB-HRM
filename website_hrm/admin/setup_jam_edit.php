        ...
        <div class="row">
          ...
          <div class="card">
            <div class="card-header">
              ...
              include 'koneksi.php';
              $id = $_GET['id'];
              $sql = mysqli_query($koneksi, "SELECT * FROM setup_jam WHERE id='$id'") or die(mysqli_error($koneksi));
              $data = mysqli_fetch_array($sql);
              ?>

              <form role="form" action="setup_jam_edit_proses.php" method="POST">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="time" name="jam_keluar_set" class="form-control"  value="<?php echo $data['jam_keluar_set'] ?>" required0>
                  </div>
                  <div class="form-group">
