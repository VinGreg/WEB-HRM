        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <a href ="absensi_tambah.php"><button type="submit" class="btn btn-primary">Tambah</button><a>
              </div>
         ...
         while ($data = mysqli_fetch_array($sql)) {
           ...
           ?>
                                                    ...
                                                    <td>
                                                          <a href ="absensi_edit.php<?php echo '?id=' . $id; ?> <button type="submit" class="btn btn-warning">Edit<a>  
