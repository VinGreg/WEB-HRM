                ...
                <div class="card">
                  <div class="card-header">
                    <div class="card card-primary">
                      ...
                      <!-- /.card-header -->
                      <!-- form start -->
                      <form role="form" action="setup_absensi_tambah_proses.php" method="POST">
                        <div class="card-body">
                          ...
                          <div class="form-group">
                            ...
                            <input type="number" name="jumlah_hari_cuti" class="form-control"  value="<?php echo $data['jumlah_hari_cuti'] ?>" required>
                          </div>
                          <div class="form-group">
