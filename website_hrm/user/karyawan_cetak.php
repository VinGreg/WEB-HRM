...
<div class="container">
        ...
        SELECT karyawan.*, bidang.nama_bid, jabatan.nama_jab, riwayat_pendidikan.pendidikan_terakhir, sistem_gaji.jumlah_gaji, sistem_tunjangan.jumlah_tunjangan
        FROM karyawan
        LEFT JOIN bidang ON karyawan.kode_bid = bidang.kode_bid
        LEFT JOIN jabatan ON karyawan.kode_jab = jabatan.kode_jab
        LEFT JOIN riwayat_pendidikan ON karyawan.kode_pendidikan = riwayat_pendidikan.nama_pendidikan
